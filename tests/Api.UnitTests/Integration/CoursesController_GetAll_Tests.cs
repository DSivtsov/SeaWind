...
[Collection("Test Main Database collection")]
public class CoursesController_GetAll_Tests
{
    private readonly TestMainDbFixture _testMainDbFixture;
    ...
    public CoursesController_GetAll_Tests(TestMainDbFixture testMainDbFixture)
    {
