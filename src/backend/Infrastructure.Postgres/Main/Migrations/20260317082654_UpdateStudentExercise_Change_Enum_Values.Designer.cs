...
namespace Infrastructure.Postgres.Main.Migrations
{
    ...
    [Migration("20260317082654_UpdateStudentExercise_Change_Enum_Values")]
    partial class UpdateStudentExercise_Change_Enum_Values
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("student_exercises", "main", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_student_exercises_Status", "\"Status\" IN ('OnStudent','OnMentor','Accepted')");
                        });
                });
